...
export interface ITechnicalSkill {
    category: 'Ngôn ngữ lập trình' | 'Framework' | 'OS' |'Database' | 'Cloud' | 'Version Control' | 'Công cụ quản lý dự án' | 'Khác';
    name: string;
...
export interface IIntroductionQuestions {
    preferredRoles:  {preferredRole: 'Frontend' | 'Backend' | 'Fullstack' | 'Mobile' | 'DevOps' | 'QA' | 'Khác'}[];
...
const TechnicalSkillSchema = new Schema<ITechnicalSkill>(
    {
        category: { type: String, enum: ['Ngôn ngữ lập trình', 'Framework', 'OS', 'Database', 'Cloud', 'Version Control', 'Công cụ quản lý dự án', 'Khác'], required: true },
...
const IntroductionQuestionsSchema = new Schema<IIntroductionQuestions>(
    {
        preferredRoles: [{ preferredRole: { type: String, enum: ['Frontend', 'Backend', 'Fullstack', 'Mobile', 'DevOps', 'QA', 'Khác'], required: true } }],
...
const CandidateProfileSchema = new Schema<ICandidateProfile>(
    {
        ...
        introductionQuestions: { type: IntroductionQuestionsSchema, required: true },
    },
    { timestamps: true }
);
